import { SnapshotStorage } from '../src/index';
import { SnapshotLoader } from '../src/index';
...
console.log('\n' + '='.repeat(60));
console.log('STEP 2: Converting snapshot for validator');
console.log('='.repeat(60));

const loader = new SnapshotLoader('./.validator-data');
const accountDir = loader.loadSnapshotForValidator(snapshot);
